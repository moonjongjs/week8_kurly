...
export default function Sub03Component() {
   ...
   useEffect(()=>{
    ...
    return (
        <main id='mainSub03' className='mainSub'>
            <section id="section1">
               <div className="container">
                    <div className="gap">
                        ...
                        <div className="content">
                            <a href="!#"><img src="./img/sub_page/sub_03/aIcWA1qAhYmdq7llqnbhuurr83QSGPUwaNG2haqc.jpg" alt="" /></a> 
                        </div> 
                    </div>
               </div> 
            </section>
                        ...
                        <div className="content">
                            <div className="left">
                                <div className="left-head">
                                    <h3>필터</h3>
                                    <span><img src="./img/sub_page/sub_03/icon_refresh.svg" alt="" />초기화</span>
                                </div>
                                <nav id='category'>
                                    <ul>
                                        <li>
                                            ...
                                            <div className="sub sub1">
                                                ...
                                                <button>카테고리 더보기 <img src="./img/sub_page/sub_03/icon_arrow_right.svg" alt="" /></button>
                                            </div>
                                        </li>
                                        <li>                                            
                            ...
                            <div className="right">
                                <div className="right-head">
                                    <span>총 205건</span>
                                    <span>
                                        <a href="!#">추천순 </a><img src="./img/sub_page/sub_03/quesion.svg" alt="" />
                                        <i>|</i>
                                      ...
                                      state.상품.map((item, idx)=>{
                                        return(
                                            <li className="list" key={item.번호}>
                                                <div className="list-gap" onClick={(e)=>onClickViewProduct(e, item, `./img/sub_page/sub_03/${item.이미지}`)}>
                                                    <div className="img-box">
                                                        <img src={`./img/sub_page/sub_03/${item.이미지}`} alt="" />
