...
export default function Sub05SignUpComponent({회원가입}) {
    ...
    const onClickDuplCheck=(e, value)=>{
        ...
        if(value==='ID중복확인'){
            ...
            axios({
                url:'http://moonjong2.dothome.co.kr/week8_kurly/id_duplicate_check.php',
                method:'post',
                data: newFormData
            })
            .then((res) => {
            ...
            axios({
                url:'http://moonjong2.dothome.co.kr/week8_kurly/email_duplicate_check.php',
                method:'post',
                data: newFormData
            })
            .then((res) => {
    ...
    const onClickHpBtn=(e)=>{
        ...
        if(isUserHpDis===true){ // 다른번호인증 
            ...
            if(regExp.test(휴대폰)===false){
                ...
                confrimModalOpen(휴대폰인증발급번호 + '지금 전송된 인증번호를 입력해주세요', 1);
            }
    ...
    const onSubmitSignup=(e)=>{
        ...
        if( 아이디==='' ){
            ...
            axios({
                url:'http://moonjong2.dothome.co.kr/week8_kurly/signup.php',
                method: 'POST',
                data: newFormData
            })
            .then((res)=>{
